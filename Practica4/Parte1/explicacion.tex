...
\lstset{emph={%  
    ...
    r0,r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,r16,r17,r18,r19%
    r20,r21,r22,r23,r24,r25,r26,r27,r28,r29,r30,r31%
	$0,$zero,$s0,$s1,$s2,$s3,$s4,$s5,$s6,$s7,$sp,$ra,$t0,$t1,$t2,$t3,$t4,$t5,$t6,$t7,$t8,$t9,$0%
...
B: .word 2
.code
   LD   $t1, A($0) ; Cargo $t1 con A
   LD   $t2, B($0) ; Cargo $t2 con B
   SD   $t2, A($0) ; Guardo en A $t2
   SD   $t1, B($0) ; Guardo en B $t1
   HALT
\end{lstlisting}
